...
## 本システムで利用可能な機能
本システムは、ユーザが商品の閲覧・購入・出品を一気通貫で行える CtoC マーケットプレイスです。認証、メール検証、決済、プロフィール管理までを Laravel で実装しています。
購入処理は、Stripeを利用しています。

- **ログイン&ログアウト画面**

   メールアドレスとパスワードで認証し、セッション管理でログイン状態を保持します。ログアウト時は安全にセッションを破棄します。

- **商品一覧画面（トップ画面）**

   出品中の商品を一覧表示します。商品画像・価格・状態などの主要情報を確認し、詳細画面へ遷移できます。

- **商品一覧画面（トップ画面）_マイリスト**

   いいねした商品（マイリスト）を一覧で確認できます。興味のある商品を後から比較・購入しやすくする機能です。

- **会員登録画面**

   名前・メールアドレス・パスワードを登録し、新規ユーザを作成します。バリデーションと重複チェックで不正な登録を防ぎます。

- **メール認証画面**

   登録後のメール認証リンクを通じて本人確認を行います。未認証ユーザの利用範囲を制御し、アカウントの信頼性を担保します。

- **商品詳細画面**

   商品画像、説明、カテゴリ、状態、価格、出品者情報を表示します。購入判断に必要な情報を 1 画面で確認できます。

- **商品購入画面**

   購入内容を確認し、Stripe（テストモード）で決済します。決済完了後は購入履歴へ反映され、重複購入を防ぐ制御を行います。

- **住所変更ページ**

   購入時に利用する配送先住所を更新できます。プロフィール情報と連携して、購入フローの入力負担を減らします。

- **商品出品画面**

   商品名・説明・価格・カテゴリ・状態・商品画像を登録して出品できます。入力チェックと画像アップロード処理を実装しています。

- **プロフィール画面**

   ユーザの基本情報（名前、自己紹介、プロフィール画像など）を表示するマイページです。購入者・出品者としての活動状況を確認できます。

- **プロフィール編集画面**

   表示名、自己紹介、プロフィール画像などを更新できます。プロフィールの更新内容はマイページに即時反映されます。

- **プロフィール画面_購入した商品一覧**

   これまでに購入した商品の履歴を一覧表示します。取引の振り返りや購入済み商品の再確認に利用できます。

- **プロフィール画面_出品した商品一覧**

   自分が出品した商品の一覧を表示します。販売中の商品管理や出品実績の確認に利用できます。
...
<img src="docs/商品一覧画面.png" alt="商品一覧画面" width="480">

**商品詳細画面**

<img src="docs/商品詳細画面.png" alt="商品詳細画面" width="480">
